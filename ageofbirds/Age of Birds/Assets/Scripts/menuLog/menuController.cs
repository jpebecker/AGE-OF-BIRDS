...
public class menuController : MonoBehaviourPunCallbacks
{
    ...
    //private UiController _uiController;//controlador de botões e interface de jogo
    ...
    {
        //_uiController.ShowServerData(string.Format("Conectado a região: " + PhotonNetwork.CloudRegion + " | Versão : " + versao_aplicativo + " | Número máximo de jogadores: " + playerporsala));
